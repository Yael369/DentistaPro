<x-app-layout>
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-slate-800">Nuevo Dentista</h1>
                <p class="text-gray-500 mt-1">Registra un nuevo dentista en el sistema</p>
            </div>
            <form method="POST" action="{{ route('admin.guardarDentista') }}">
                @csrf
                <div class="space-y-4">
